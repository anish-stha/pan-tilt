...
angular_Servo1 = AngularServo(17, min_angle = -45, max_angle = 45, pin_factory = pigpio_factory)
angular_Servo1.angle = 0
angular_Servo2 = AngularServo(27, min_angle = -45, max_angle = 45, pin_factory = pigpio_factory)
